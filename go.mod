...
require (
	...
	github.com/flyteorg/flyteplugins v1.0.0 // indirect
...
replace github.com/flyteorg/flyteidl => github.com/flyteorg/flyteidl v1.5.18-0.20230916075659-3b7389f569ae
