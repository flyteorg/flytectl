...
Registration and fast registration bascially mean the same. In fast registration, the input provided by the user is fast serialized proto that is generated by pyflyte. 
