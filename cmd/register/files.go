...
const (
	...
	registerFilesLong  = `
Register all the serialized protobuf files including tasks, workflows and launch plans with default v1 version.
...
Registration and fast registration basically mean the same. In fast registration, the input provided by the user is fast serialized proto that is generated by pyflyte. 
