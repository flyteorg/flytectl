...
The command update takes the input for execution cluster label from the config file ecl.yaml
Ex:  content of ecl.yaml
...
Updating execution cluster label for project, domain and workflow combination. This will take precedence over any other
