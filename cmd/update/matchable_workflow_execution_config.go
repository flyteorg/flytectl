...
The command update takes the input for workflow execution config from the config file wec.yaml
...
Updating workflow execution config for project, domain and workflow combination. This will take precedence over any other
