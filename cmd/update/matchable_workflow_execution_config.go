...
const (
	workflowExecutionConfigShort = "Updates matchable resources of task attributes"
...
func updateWorkflowExecutionConfigFunc(ctx context.Context, args []string, cmdCtx cmdCore.CommandContext) error {
	...
	taskResourceAttrFileConfig := workflowexecutionconfig.WorkflowExecutionConfigFileConfig{}
