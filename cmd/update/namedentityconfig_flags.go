...
func (cfg NamedEntityConfig) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.BoolVar(&namedEntityConfig.DryRun, fmt.Sprintf("%v%v", prefix, "dryRun"), namedEntityConfig.DryRun, "execute local operations without making any modifications (skip or mock all server communication)")
	return cmdFlags
}
