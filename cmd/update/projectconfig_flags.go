...
func (cfg ProjectConfig) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.BoolVar(&projectConfig.ActivateProject, fmt.Sprintf("%v%v", prefix, "activateProject"), projectConfig.ActivateProject, "Activates the project specified as argument.")
	cmdFlags.BoolVar(&projectConfig.ArchiveProject, fmt.Sprintf("%v%v", prefix, "archiveProject"), projectConfig.ArchiveProject, "Archives the project specified as argument.")
	return cmdFlags
}
