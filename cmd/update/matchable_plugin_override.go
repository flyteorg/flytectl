...
const (
	pluginOverrideShort = "Updates matchable resources of plugin overrides"
	pluginOverrideLong  = `
...
The command update takes the input for plugin overrides from the config file po.yaml
...
Updating plugin override for project, domain and workflow combination. This will take precedence over any other
