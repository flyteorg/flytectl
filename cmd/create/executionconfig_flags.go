...
func (ExecutionConfig) mustJsonMarshal(v interface{}) string {
...
func (cfg ExecutionConfig) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.BoolVar(&executionConfig.DryRun, fmt.Sprintf("%v%v", prefix, "dryRun"), executionConfig.DryRun, "execute local operations without making any modifications")
	return cmdFlags
}
