...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_ctrlPlane", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("ctrlPlane", testValue)
			if vBool, err := cmdFlags.GetBool("ctrlPlane"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vBool), &actual.ControlPlane)
