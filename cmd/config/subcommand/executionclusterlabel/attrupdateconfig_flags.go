...
func (cfg AttrUpdateConfig) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.BoolVar(&DefaultUpdateConfig.DryRun, fmt.Sprintf("%v%v", prefix, "dryRun"), DefaultUpdateConfig.DryRun, "execute local operations without making any modifications (skip or mock all server communication)")
	return cmdFlags
}
