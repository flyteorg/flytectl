...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_debug", func(t *testing.T) {
		...
		t.Run("Override", func(t *testing.T) {
			...
			cmdFlags.Set("debug", testValue)
			if vBool, err := cmdFlags.GetBool("debug"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vBool), &actual.Debug)
	...
	t.Run("Test_flytesnacks-path", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("flytesnacks-path", testValue)
			if vString, err := cmdFlags.GetString("flytesnacks-path"); err == nil {
