...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.BoolVar(&DefaultConfig.PrintCommand, fmt.Sprintf("%v%v", prefix, "printCommand"), DefaultConfig.PrintCommand, "Optional. Only print the command to start the docker container.")
	return cmdFlags
}
