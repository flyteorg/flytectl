...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_filters", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("filters", testValue)
			if vString, err := cmdFlags.GetString("filters"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vString), &actual.Filters)
