...
const (
	...
	execLong  = `
Run non-interactive command inside the Sandbox container and immediately returns the output. By default, ``flytectl exec`` is present in /root directory inside the Sandbox container.
