...
Delete execution cluster label for project and domain.
...
e.g., content of ecl.yaml which will use the project domain and workflow name to delete the resource.
