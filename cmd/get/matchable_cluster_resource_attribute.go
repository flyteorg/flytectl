...
Retrieves cluster resource attributes for the given project and domain, combination or additionally with workflow name.

Retrieves cluster resource attribute for the project and domain.
...
Retrieves cluster resource attributes for the project, domain and workflow.
...
Writing the cluster resource attributes to a file. If there are no cluster resource attributes, command would return an error.
Here, the command gets task resource attributes and writes the config file to cra.yaml file.
