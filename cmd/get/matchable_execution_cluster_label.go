...
Writes the execution cluster label to a file. If there is no execution cluster label, the command throws an error.
The command get execution cluster label writes the config file to ecl.yaml file.
