...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_f", func(t *testing.T) {
		t.Run("DefaultValue", func(t *testing.T) {
			// Test that default value is set properly
			if vString, err := cmdFlags.GetString("f"); err == nil {
		...
		t.Run("Override", func(t *testing.T) {
			...
			cmdFlags.Set("f", testValue)
			if vString, err := cmdFlags.GetString("f"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vString), &actual.F)
