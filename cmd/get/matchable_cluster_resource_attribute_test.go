...
func TestGetClusterResourceAttributes(t *testing.T) {
	...
	t.Run("successful get project domain attribute", func(t *testing.T) {
		...
		tearDownAndVerify(t, s.Reader, `{"project":"dummyProject","domain":"dummyDomain","attributes":{"foo":"bar"}}`)
	})
	...
	t.Run("successful get workflow attribute", func(t *testing.T) {
		...
		tearDownAndVerify(t, s.Reader, `{"project":"dummyProject","domain":"dummyDomain","workflow":"workflow","attributes":{"foo":"bar"}}`)
	})
