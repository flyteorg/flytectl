...
func TestGetExecutionClusterLabel(t *testing.T) {
	...
	t.Run("successful get project domain attribute", func(t *testing.T) {
		...
		tearDownAndVerify(t, s.Reader, `{"project":"dummyProject","domain":"dummyDomain","value":"foo"}`)
	})
	...
	t.Run("successful get workflow attribute", func(t *testing.T) {
		...
		tearDownAndVerify(t, s.Reader, `{"project":"dummyProject","domain":"dummyDomain","workflow":"workflow","value":"foo"}`)
	})
