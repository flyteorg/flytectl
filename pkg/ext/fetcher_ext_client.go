...
type AdminFetcherExtInterface interface {
	...
	// FetchWorkflowAttributes fetches workflow attributes within a project, domain for a particular matchable resource
	FetchWorkflowAttributes(ctx context.Context, project, domain, name string,
		rsType admin.MatchableResource) (*admin.WorkflowAttributesGetResponse, error)

	// FetchProjectDomainAttributes fetches project domain attributes for a particular matchable resource
	FetchProjectDomainAttributes(ctx context.Context, project, domain string,
